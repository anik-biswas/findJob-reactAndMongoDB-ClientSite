        ...
        <div>
            <div className="navbar bg-[#bef7ef] rounded-lg p-0 md:p-2">
                <div className="navbar-start">
                    ...
                    <img className=" w-16 md:w-24 h-16 md:h-20" src="https://i.ibb.co/M6dq2J8/joblogo-removebg-preview.png" alt="" />
                    <a className="normal-case text-2xl hidden md:block lg:block">Find Job</a>
                </div>
